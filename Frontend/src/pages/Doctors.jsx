  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-start gap-4 my-4">
        <button
          className={`py-1 px-3 border border-gray-200  rounded text-sm transition-all sm:hidden ${
        ...
        <div className="w-full grid grid-cols-auto custom-grid gap-5 gap-y-6">
          {doctors
            .filter((doctor) => !speciality || doctor.speciality === speciality)
            .map((item, index) => (
              <div
