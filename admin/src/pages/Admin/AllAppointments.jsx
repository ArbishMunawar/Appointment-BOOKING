    ...
    <div className="w-full max-w-6xl m-5">
      ...
      <div className="bg-white border border-gray-300 text-sm max-h-[80vh] min-h-[60vh] overflow-y-scroll">
        ...
        {appointments.map((item, index) => (
          <div
            className="flex flex-wrap justify-between max-sm:gap-2 sm:grid  grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] items-center text-gray-500 py-3 px-6 border-b hover:bg-gray-200"
            key={index}
          >
            ...
            <div className="flex items-center gap-2">
              <img
                ...
                src={item.userData?.image || "Picture doesnt exist"}
                alt=""
              />
            ...
            <div className="flex items-center gap-2">
              <img
                ...
                src={item.docData?.image || "Picture doesnt exist"}
                alt=""
              />
